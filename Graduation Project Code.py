...
print("a_pcr为"+str(round(a_pcr,4)))
print("a_hcr为"+str(round(a_hcr,4)))
print("theta_sqrt为"+str(round(theta_sqrt,4)))
...
print("f_p1为："+str(f_p1)+"m2")
print("f_p为："+str(f_p)+"m2")
print("f_3为："+str(f_3)+"m2")
print("f_2为："+str(f_2)+"m2")
d_p,d_pcr=round(math.sqrt(4*f_p/PI),4),round(math.sqrt(4*f_pcr/PI),4)
print("喷嘴入口直径为："+str(d_p)+"m")
print("喷嘴临界直径为："+str(d_pcr)+"m")
print("喷嘴出口直径为："+str(d_1)+"m")
print("混合室喉部直径为："+str(d_3)+"m")
print("自由流束终截面直径为："+str(d_4)+"m")
print("扩散器出口直径为："+str(d_c)+"m")
print("喷嘴出口到混合室入口距离为："+str(l_c)+"m")
print("混合室长度为："+str(l_k)+"m")
print("扩散器长度为："+str(l_PI)+"m")